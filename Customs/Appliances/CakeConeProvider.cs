...
namespace KitchenIceCreamParlor.Customs.Appliances
{
    public class CakeConeProvider : CustomAppliance
    {
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Cake Cone Provider").AssignMaterialsByNames();

        // Properties - The Properties attached to the Appliance.
        public override List<IApplianceProperty> Properties => new List<IApplianceProperty>
        {
            KitchenPropertiesUtils.GetUnlimitedCItemProvider(GDOUtils.GetCustomGameDataObject<CakeCone>().ID)
        };
        ...
        public override List<(Locale, ApplianceInfo)> InfoList => new List<(Locale, ApplianceInfo)>
        {
            ...
            {
                Name = "Cake Cones",
                Description = "Provides Cake Cones"
            })
        };
        ...
        public override void OnRegister(Appliance gameDataObject)
        {
            ...
            var holdTransform = Prefab.GetChild("Counter/HoldPoint").transform;
