...
namespace KitchenIceCreamParlor.Customs.Items
{
    public class FudgeSauce : CustomItem
    {
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Fudge Sauce").AssignMaterialsByNames();
